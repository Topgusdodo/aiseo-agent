...
|---|---|---|---|
| S6-01 | `technical-seo-audit: 审计 https://www.python.org/，sample_pages=0。请输出基础元数据、问题清单、优化建议，并覆盖 robots、sitemap、canonical、hreflang。` | B Phase2 | ≥1 LLM call · 3 章节报告 · technical SEO 信号 ≥2 · 0 leak |
...
| S6-03 | `competitor-analysis: 主站 https://www.python.org/，竞品 https://www.ruby-lang.org/ 和 https://nodejs.org/。请输出对比矩阵、领先落后判断和机会清单。` | B Phase2 | ≥1 LLM call · 对比矩阵 · relative position · 0 leak |
| S6-04 | `seo-weekly-report: 为 https://www.python.org/ 生成首次周报。如果没有历史快照，请明确这是首次基线报告，下次起产 delta，不要编造新增或已修复项。` | B Phase2 | ≥1 LLM call · baseline 语义 · 不编造 delta · 0 leak |
